...
class TodayScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, watch) {
    ...
    List<Todo> todayTodo = todos.where((element) =>
    calculateDifference(DateTime.parse(element.dateTime.substring(0,10))) == 0
    ).toList();
    return Scaffold(
      body:todayTodo == null ? Center(child: Text(' Add Some Todo for Today')) : Padding(
